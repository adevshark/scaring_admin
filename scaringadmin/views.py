...
def sign_in(request):
    ...
    if request.method == "POST":
        ...
        if not user:
            ...
            return HttpResponseRedirect('/phonenumberverify?email=' + email + "&password=" + password)
...
def phonenumberverify(request):
    if request.method == "GET":
        ...
        return render(request, 'auth/phonenumberverify.html',
                      {'email': email, "password": password, "verifycode": verifycode})
